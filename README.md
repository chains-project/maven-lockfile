...
- `failValidateOnPomChecksumMismatch` (`-DfailValidateOnPomChecksumMismatch`, default=false) fail the validate if the pom checksum does not match saved checksum in lockfile. Defaults to printing a warning in case of checksum mismatch.
