...
public abstract class AbstractLockfileMojo extends AbstractMojo {
    ...
    @Parameter(property = "failValidateOnPomChecksumMismatch", defaultValue = "false")
    protected String failValidateOnPomChecksumMisMatch;
    ...
    protected Config getConfig() {
        ...
        return new Config(
                ...
                Boolean.parseBoolean(failValidateOnPomChecksumMisMatch),
